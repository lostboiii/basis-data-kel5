...
<body>
    <div class="container">
        ...
        <div class="news-image">
            <img src="<?= htmlspecialchars($post['image_path'] ?? 'default.jpg') ?>" alt="Gambar tidak ditemukan" />
        </div>
        ...
        <div class="like-dislike-section">
            <form method="post">
                ...
                <button type="submit" name="action" value="like" disabled>Like (<?= $likeCount ?>)</button>
                <button type="submit" name="action" value="dislike" disabled>Dislike (<?= $dislikeCount ?>)</button>
            </form>
        </div>
