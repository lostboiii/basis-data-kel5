...
?>
 <!DOCTYPE html>
        ...
        <input type="hidden" name="id" value="">
            ...
            <input type="text" class="form-control" name="title" placeholder="Masukkan judul berita" value="">
            </div>
            <div class="form-group">
            ...
            <textarea class="form-control" name="content" rows="3" placeholder="Masukkan konten berita"></textarea>
            </div>
            <div class="form-group">
            <label for="ringkasan">Ringkasan</label>
            <input type="text" class="form-control" name="summary" placeholder="Masukkan ringkasan berita" value="">
            </div>
            <div class="form-group">
            <label for="penulis">Penulis</label>
            <input type="text" class="form-control" name="author" placeholder="Masukkan nama penulis" value="">
            </div>
            <div class="form-group">
